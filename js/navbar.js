 ...
 *
 * @param {string} id_div_navbar - The ID of the element where the navigation bar will be added.
 *
 * @example
 * // Call the function to create and add the navigation bar
 * createNavbar('idNavBar');
 */
function createNavbar(id_div_navbar) {

    // Sélection de l'élément parent dans lequel la navbar sera ajoutée
    const app = document.getElementById(id_div_navbar);
